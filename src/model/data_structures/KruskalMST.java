...
public class KruskalMST {
     ...
     * @throws Exception 
     */
    public KruskalMST(EdgeWeightedGraph G,int peso) throws Exception {
    	this.peso=peso;
    ...
    public KruskalMST(EdgeWeightedGraph G,int peso,int ini) throws Exception {
    	this.peso=peso;
        // more efficient to build heap by passing array of edges
        MinPQ<Edge> pq = new MinPQ<Edge>();
        for (Edge e : (Iterable<Edge>)G.edges()) {
            if(e.either()==ini||e.other2()==ini) {
            	pq.insert(e);
            }
